...
//                    .padding(top = 45.dp, start = 26.dp, end = 26.dp),
            ...
            InputEditar(titulo = "Nome", placeholder = "Molho de Tomate", valorCampo = nome, mudaValor = { novoValor ->
                        nome = novoValor })

            InputEditar(titulo = "Lote", placeholder = "Lote 1", valorCampo = lote, mudaValor = { novoValor ->
                lote = novoValor })

            InputEditar(titulo = "Categoria", placeholder = "Molhos", valorCampo = categoria, mudaValor = { novoValor ->
                categoria = novoValor })

            InputEditar(titulo = "Local Armazenamento", placeholder = "Geladeira", valorCampo = localArmazenamento, mudaValor = { novoValor ->
